...
&nbsp;&nbsp; - classes: 2 classes
<br />
5. go to https://lisaschulzke.github.io/trackrails_ml/ and train the algorithm class by class (1st class is no objects on the track, 2nd class is objects on the track).
<br />
